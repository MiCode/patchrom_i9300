...
.method private SettingDefaultSoundAgain(Landroid/content/ContentResolver;Landroid/net/Uri;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 2302
    .local v7, existingSettingValue:Ljava/lang/String;
    const/4 v8, 0x0

    .line 2303
    .local v8, resultMediaCursor:Landroid/database/Cursor;
    const/4 v9, 0x0

    .line 2304
    .local v9, resultSettingCursor:Landroid/database/Cursor;
    ...
    .line 2315
    invoke-static {p3, v10, v11}, Landroid/content/ContentUris;->withAppendedId(Landroid/net/Uri;J)Landroid/net/Uri;
...
.method static synthetic access$1500()Z
    ...
    .prologue
    .line 131
    sget-boolean v0, Landroid/media/MediaScanner;->FLAG_HIDEVOICEFILESINMUSIC:Z
...
.method static synthetic access$2700(Landroid/media/MediaScanner;Ljava/lang/String;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 131
    invoke-direct {p0, p1}, Landroid/media/MediaScanner;->writeLog(Ljava/lang/String;)V
...
.method private getFormatString(Ljava/lang/String;Ljava/util/Calendar;)Ljava/lang/String;
    .locals 3
    .parameter "pattern"
    .parameter "cal"
...
.method private getSysDate(Ljava/lang/String;)Ljava/lang/String;
    .locals 3
    .parameter "pattern"
    ...
    invoke-direct {p0, p1, v0}, Landroid/media/MediaScanner;->getFormatString(Ljava/lang/String;Ljava/util/Calendar;)Ljava/lang/String;
...
.method private prescan(Ljava/lang/String;Z)V
    ...
    .line 1457
    sget-boolean v1, Landroid/media/MediaScanner;->FLAG_HIDEVOICEFILESINMUSIC:Z
    ...
    const-string v2, "DBG new mWasEmptyPriorToScan is "
    ...
    iget-boolean v2, v0, Landroid/media/MediaScanner;->mWasEmptyPriorToScan:Z
    ...
    invoke-direct {v0, v1}, Landroid/media/MediaScanner;->writeLog(Ljava/lang/String;)V
    ...
    const-string/jumbo v3, "new mWasEmptyPriorToScan is "
    ...
    iget-boolean v3, v0, Landroid/media/MediaScanner;->mWasEmptyPriorToScan:Z
    ...
    .line 1491
    :cond_4
    sget-boolean v2, Landroid/media/MediaScanner;->FLAG_HIDEVOICEFILESINMUSIC:Z
    ...
    const-string v3, "DBG final mWasEmptyPriorToScan is "
    ...
    invoke-direct {v0, v2}, Landroid/media/MediaScanner;->writeLog(Ljava/lang/String;)V
    ...
    const-string v13, "DBG final mWasEmptyPriorToScan is "
    ...
    iget-boolean v13, v0, Landroid/media/MediaScanner;->mWasEmptyPriorToScan:Z
    ...
    const-string v2, "DBG final mWasEmptyPriorToScan is "
...
.method private writeLog(Ljava/lang/String;)V
    ...
    .line 2210
    .local v2, file:Ljava/io/BufferedWriter;
    const-string v4, "MediaScannerLog.txt"
    ...
    .end local v2           #file:Ljava/io/BufferedWriter;
    .local v3, file:Ljava/io/BufferedWriter;
    move-object v2, v3

    .line 2225
    .end local v3           #file:Ljava/io/BufferedWriter;
    .restart local v2       #file:Ljava/io/BufferedWriter;
    :goto_0
    :try_start_1
    const-string/jumbo v5, "yyyy-MM-dd hh:mm:ss "

    invoke-direct {p0, v5}, Landroid/media/MediaScanner;->getSysDate(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v2, p1, v5, v6}, Ljava/io/BufferedWriter;->write(Ljava/lang/String;II)V
...
.method public scanDirectories([Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v30, "processDirectory :  "
    ...
    const-string/jumbo v30, "ms (parsing time: "
    ...
    const-string/jumbo v30, "postscan time: "
    ...
    const-string/jumbo v30, "ms (bulkEraser : "
