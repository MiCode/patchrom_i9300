...
.method public static setActualDefaultRingtoneUri(Landroid/content/Context;ILandroid/net/Uri;)V
    ...
    :goto_1
    invoke-static {v9, v5, v7}, Landroid/provider/Settings$System;->putString(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string/jumbo v9, "sound_profile_mode"
    ...
    .line 673
    .local v2, PROFILE_TABLE:Ljava/lang/String;
    const-string v7, "content://com.android.settings/profile"
    ...
    .line 674
    .local v1, PROFILE_CONTENT_URI:Landroid/net/Uri;
    ...
    .line 677
    const-string/jumbo v9, "profile_ringtone"
    ...
    invoke-virtual {v7, v3, v6, v8, v8}, Landroid/content/ContentResolver;->update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I

    goto :goto_0

    .end local v0           #AUTHORITY:Ljava/lang/String;
    .end local v1           #PROFILE_CONTENT_URI:Landroid/net/Uri;
    .end local v2           #PROFILE_TABLE:Ljava/lang/String;
    .end local v3           #_uri:Landroid/net/Uri;
    .end local v4           #profileMode:I
    ...
    .restart local v1       #PROFILE_CONTENT_URI:Landroid/net/Uri;
    .restart local v2       #PROFILE_TABLE:Ljava/lang/String;
    .restart local v4       #profileMode:I
    ...
    .line 679
    const-string/jumbo v9, "profile_notification_tone"
