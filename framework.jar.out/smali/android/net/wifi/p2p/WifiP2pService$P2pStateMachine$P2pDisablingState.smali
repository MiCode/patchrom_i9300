...
.method public enter()V
    ...
    .line 639
    invoke-static {}, Landroid/net/wifi/WifiNative;->p2pFlush()Z
    ...
    invoke-static {v0}, Landroid/net/wifi/p2p/WifiP2pService;->access$100(Landroid/net/wifi/p2p/WifiP2pService;)I
    ...
    #getter for: Landroid/net/wifi/p2p/WifiP2pService;->bAirPlaneMode:Z
    ...
    const-string v1, " 111 P2pDisablingState : WIFI_STATE_DISABLED ."
    ...
    invoke-static {v0}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$2400(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)Landroid/net/wifi/WifiMonitor;
    ...
    invoke-static {v0, v2}, Landroid/net/wifi/WifiNative;->callSECApiBoolean(IZ)I
    ...
    const-string v1, " 222 P2pDisablingState : WIFI_STATE_DISABLED . else "
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    .line 668
    iget-object v2, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine$P2pDisablingState;->this$1:Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;
    ...
    #getter for: Landroid/net/wifi/p2p/WifiP2pService;->bAirPlaneMode:Z
    invoke-static {v2}, Landroid/net/wifi/p2p/WifiP2pService;->access$2100(Landroid/net/wifi/p2p/WifiP2pService;)Z
    ...
    const-string v3, "3333 P2pDisablingState : WIFI_STATE_DISABLED ."
    ...
    #getter for: Landroid/net/wifi/p2p/WifiP2pService;->mHangEvent:Z
    invoke-static {v2}, Landroid/net/wifi/p2p/WifiP2pService;->access$2200(Landroid/net/wifi/p2p/WifiP2pService;)Z
    ...
    const-string v2, "HANG event. do NOTHING to do"

    #calls: Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->loge(Ljava/lang/String;)V
    invoke-static {v0, v2}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$1000(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Ljava/lang/String;)V

    .line 677
    iget-object v0, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine$P2pDisablingState;->this$1:Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;

    invoke-virtual {v0, v5}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->sendMessage(I)V
    ...
    invoke-virtual {v2, v0}, Landroid/net/wifi/WifiMonitor;->SetP2pMonitor(Z)V
    ...
    new-instance v2, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine$P2pDisablingState$1;

    invoke-direct {v2, p0}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine$P2pDisablingState$1;-><init>(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine$P2pDisablingState;)V
    ...
    invoke-static {v0, v2}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$2800(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Lcom/android/internal/util/IState;)V
    ...
    invoke-static {v0, p1}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$2900(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Landroid/os/Message;)V
