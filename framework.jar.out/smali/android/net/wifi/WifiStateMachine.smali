...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iput v6, p0, Landroid/net/wifi/WifiStateMachine;->CW_WIFI_TURNED_OFF:I

    .line 169
    const/4 v6, 0x1

    iput v6, p0, Landroid/net/wifi/WifiStateMachine;->CW_WIFI_FORGET_AP:I

    .line 170
    const/4 v6, 0x2

    iput v6, p0, Landroid/net/wifi/WifiStateMachine;->CW_WIFI_DORMANCY:I

    .line 171
    const/4 v6, 0x3

    iput v6, p0, Landroid/net/wifi/WifiStateMachine;->CW_WIFI_SWITCH_AP:I

    .line 172
    const/4 v6, 0x4

    iput v6, p0, Landroid/net/wifi/WifiStateMachine;->CW_WIFI_TURNED_OFF_WifiEnabler:I

    .line 173
    const/4 v6, 0x5

    iput v6, p0, Landroid/net/wifi/WifiStateMachine;->CW_WIFI_AIRPLANE_MODE:I

    .line 174
    const/4 v6, 0x6

    iput v6, p0, Landroid/net/wifi/WifiStateMachine;->CW_WIFI_DEVICE_SHUTDOWN:I

    .line 176
    const/4 v6, -0x1

    iput v6, p0, Landroid/net/wifi/WifiStateMachine;->mCWState:I

    .line 184
    const/4 v6, -0x1

    iput v6, p0, Landroid/net/wifi/WifiStateMachine;->mstoppingnetid:I

    .line 185
    const/4 v6, 0x0

    iput-boolean v6, p0, Landroid/net/wifi/WifiStateMachine;->mdisableOthers:Z

    .line 186
    const/4 v6, -0x1

    iput v6, p0, Landroid/net/wifi/WifiStateMachine;->mstoppingtype:I
    ...
    iput-object v6, p0, Landroid/net/wifi/WifiStateMachine;->mCwHandler:Landroid/os/Handler;
    ...
    .line 603
    new-instance v6, Landroid/net/wifi/WifiStateMachine$SupplicantStoppingStateForConcurrent;

    invoke-direct {v6, p0}, Landroid/net/wifi/WifiStateMachine$SupplicantStoppingStateForConcurrent;-><init>(Landroid/net/wifi/WifiStateMachine;)V

    iput-object v6, p0, Landroid/net/wifi/WifiStateMachine;->mSupplicantStoppingStateForConcurrent:Lcom/android/internal/util/State;
    ...
    iput-boolean v6, p0, Landroid/net/wifi/WifiStateMachine;->bEnableWifiSettingsDialog:Z
    ...
    iput-boolean v6, p0, Landroid/net/wifi/WifiStateMachine;->mHangEventArrived:Z

    .line 2186
    new-instance v6, Landroid/net/wifi/WifiStateMachine$5;

    invoke-direct {v6, p0}, Landroid/net/wifi/WifiStateMachine$5;-><init>(Landroid/net/wifi/WifiStateMachine;)V

    iput-object v6, p0, Landroid/net/wifi/WifiStateMachine;->mCWToWiFiEventReceiver:Landroid/content/BroadcastReceiver;
    ...
    const-string v6, "android.cw.STATE_CHANGE"
    ...
    iget-object v7, p0, Landroid/net/wifi/WifiStateMachine;->mCWToWiFiEventReceiver:Landroid/content/BroadcastReceiver;
    ...
    .line 809
    iget-object v6, p0, Landroid/net/wifi/WifiStateMachine;->mSupplicantStoppingStateForConcurrent:Lcom/android/internal/util/State;
...
.method static synthetic access$11602(Landroid/net/wifi/WifiStateMachine;I)I
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$11700(Landroid/net/wifi/WifiStateMachine;)J
    .locals 2
    .parameter "x0"
...
.method static synthetic access$11702(Landroid/net/wifi/WifiStateMachine;J)J
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$11800(Landroid/net/wifi/WifiStateMachine;)Z
    .locals 1
    .parameter "x0"
...
.method static synthetic access$12400(Landroid/net/wifi/WifiStateMachine;I)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$1400(Landroid/net/wifi/WifiStateMachine;Landroid/content/Intent;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$14508(Landroid/net/wifi/WifiStateMachine;)I
    .locals 2
    .parameter "x0"
...
.method static synthetic access$1502(Landroid/net/wifi/WifiStateMachine;Z)Z
    ...
    .prologue
    .line 146
    iput-boolean p1, p0, Landroid/net/wifi/WifiStateMachine;->mHangEventArrived:Z
...
.method static synthetic access$15402(Z)Z
    .locals 0
    .parameter "x0"
...
.method static synthetic access$1600(Landroid/net/wifi/WifiStateMachine;Landroid/os/Message;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$16000(Landroid/net/wifi/WifiStateMachine;)Landroid/app/AlarmManager;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$200(Landroid/net/wifi/WifiStateMachine;)I
    .locals 1
    .parameter "x0"
...
.method static synthetic access$202(Landroid/net/wifi/WifiStateMachine;I)I
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$2100(Landroid/net/wifi/WifiStateMachine;)Landroid/net/wifi/p2p/WifiP2pManager;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$2102(Landroid/net/wifi/WifiStateMachine;Landroid/net/wifi/p2p/WifiP2pManager;)Landroid/net/wifi/p2p/WifiP2pManager;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$4700(Landroid/net/wifi/WifiStateMachine;)Landroid/net/wifi/WpsStateMachine;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$7200(Landroid/net/wifi/WifiStateMachine;Landroid/net/wifi/WifiConfiguration;I)Landroid/net/wifi/WifiConfiguration;
    .locals 1
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$7300(Landroid/net/wifi/WifiStateMachine;II)Z
    .locals 1
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$9700(Landroid/net/wifi/WifiStateMachine;Z)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method public setWifiEnabled(Z)V
    ...
    .line 867
    iget v0, p0, Landroid/net/wifi/WifiStateMachine;->mWifiP2pState:I
    ...
    iget-boolean v0, p0, Landroid/net/wifi/WifiStateMachine;->mHangEventArrived:Z
    ...
    invoke-virtual {p0, v0, v3, v2}, Landroid/net/wifi/WifiStateMachine;->obtainMessage(III)Landroid/os/Message;
    ...
    .line 908
    iput-boolean v2, p0, Landroid/net/wifi/WifiStateMachine;->mHangEventArrived:Z
