...
# virtual methods
.method public final actionPauseMandate()V
    .locals 2
    ...
    .line 4773
    .local v0, multiWindowManager:Landroid/sec/multiwindow/IMultiWindowManager;
    invoke-interface {v0, p0}, Landroid/sec/multiwindow/IMultiWindowManager;->sendPauseAction(Landroid/app/Activity;)Z

    .line 4775
    .end local v0           #multiWindowManager:Landroid/sec/multiwindow/IMultiWindowManager;
    :cond_0
    return-void
.end method

.method public final actionResumeMandate()V
    .locals 2
    ...
    .line 4765
    .local v0, multiWindowManager:Landroid/sec/multiwindow/IMultiWindowManager;
    invoke-interface {v0, p0}, Landroid/sec/multiwindow/IMultiWindowManager;->sendResumeAction(Landroid/app/Activity;)Z
...
.method public finish()V
    ...
    :try_start_1
    invoke-virtual {v2, v3}, Landroid/content/Intent;->setAllowFds(Z)V
    ...
    invoke-interface {v3, v4, v1, v2}, Landroid/app/IActivityManager;->finishActivity(Landroid/os/IBinder;ILandroid/content/Intent;)Z
    ...
    :cond_1
    :goto_0
    invoke-static {p0}, Landroid/sec/multiwindow/MultiWindowManager;->isMultiWindowServiceEnabled(Landroid/content/Context;)Z
    ...
    .line 3807
    invoke-static {p0}, Landroid/sec/multiwindow/MultiWindowManager;->getInstance(Landroid/content/Context;)Landroid/sec/multiwindow/IMultiWindowManager;

    move-result-object v0

    .line 3808
    .local v0, multiWindowManager:Landroid/sec/multiwindow/IMultiWindowManager;
    invoke-interface {v0, p0}, Landroid/sec/multiwindow/IMultiWindowManager;->sendFinishAction(Landroid/app/Activity;)Z
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .line 1466
    .local v1, sService:Landroid/sec/multiwindow/IMultiWindowManager;
    invoke-virtual {p0}, Landroid/app/Activity;->getComponentName()Landroid/content/ComponentName;

    move-result-object v2

    invoke-interface {v1, v2}, Landroid/sec/multiwindow/IMultiWindowManager;->isRunning(Landroid/content/ComponentName;)Z
    ...
    invoke-interface {v1, v2, v3}, Landroid/sec/multiwindow/IMultiWindowManager;->orientationChangeRestore(Landroid/content/ComponentName;I)Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    .line 1475
    .end local v1           #sService:Landroid/sec/multiwindow/IMultiWindowManager;
    :cond_0
    :goto_0
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .line 875
    .local v0, multiWindowManager:Landroid/sec/multiwindow/IMultiWindowManager;
    invoke-interface {v0, p0}, Landroid/sec/multiwindow/IMultiWindowManager;->sendCreateAction(Landroid/app/Activity;)Z
...
.method public onLayoutChanged(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v0, p1}, Landroid/app/FragmentManagerImpl;->dispatchPrepareLayoutChanged(Landroid/graphics/Rect;)V
...
.method protected onPostResume()V
    ...
    .line 1104
    .local v0, multiWindowManager:Landroid/sec/multiwindow/IMultiWindowManager;
    invoke-interface {v0, p0}, Landroid/sec/multiwindow/IMultiWindowManager;->postResume(Landroid/app/Activity;)Z
...
.method public onPrepareLayoutChanged(Landroid/graphics/Rect;)V
    .locals 1
...
.method protected onResume()V
    ...
    .line 1079
    invoke-virtual {p0}, Landroid/app/Activity;->actionResumeMandate()V
...
.method protected onStart()V
    ...
    .line 1011
    iput-boolean v4, p0, Landroid/app/Activity;->mLoadersStarted:Z
    ...
    :cond_0
    :goto_0
    iput-boolean v4, p0, Landroid/app/Activity;->mCheckedForLoaderManager:Z
    ...
    .line 1025
    .local v0, multiWindowManager:Landroid/sec/multiwindow/IMultiWindowManager;
    invoke-interface {v0, p0}, Landroid/sec/multiwindow/IMultiWindowManager;->sendStartAction(Landroid/app/Activity;)Z
    ...
    .line 1014
    :cond_3
    iget-boolean v1, p0, Landroid/app/Activity;->mCheckedForLoaderManager:Z
    ...
    iget-boolean v2, p0, Landroid/app/Activity;->mLoadersStarted:Z

    const/4 v3, 0x0

    invoke-virtual {p0, v1, v2, v3}, Landroid/app/Activity;->getLoaderManager(IZZ)Landroid/app/LoaderManagerImpl;

    move-result-object v1

    iput-object v1, p0, Landroid/app/Activity;->mLoaderManager:Landroid/app/LoaderManagerImpl;
...
.method public final performResumeMandate()V
    .locals 0

    .prologue
    .line 4758
    invoke-virtual {p0}, Landroid/app/Activity;->performResume()V
...
.method public startActivityForResult(Landroid/content/Intent;I)V
    ...
    .line 3256
    .local v15, applicationPackageName:Ljava/lang/String;
    invoke-virtual/range {p1 .. p1}, Landroid/content/Intent;->getComponent()Landroid/content/ComponentName;
    ...
    .line 3258
    .local v3, intentPackageName:Ljava/lang/String;
    ...
    const-string v6, "Viewracle3D_Launcher"
    ...
    const-string/jumbo v7, "set viewracle option: packageName="
    ...
    .line 3270
    .local v4, lcdOutput:I
    const-string v5, "Resolution_Output"
    ...
    invoke-static/range {v3 .. v14}, Landroid/app/ViewracleOption;->setViewracleOption(Ljava/lang/String;I[F[I[III[I[I[III)V

    .line 3280
    .end local v3           #intentPackageName:Ljava/lang/String;
    .end local v4           #lcdOutput:I
    .end local v12           #resolutionOutput:[I
    .end local v15           #applicationPackageName:Ljava/lang/String;
    .end local v17           #isIntentViewracle:Z
    :cond_1
    :goto_0
    move-object/from16 v0, p0

    iget-object v5, v0, Landroid/app/Activity;->mParent:Landroid/app/Activity;
    ...
    iget-object v5, v0, Landroid/app/Activity;->mInstrumentation:Landroid/app/Instrumentation;

    move-object/from16 v0, p0

    iget-object v6, v0, Landroid/app/Activity;->mMainThread:Landroid/app/ActivityThread;
    ...
    iget-object v8, v0, Landroid/app/Activity;->mToken:Landroid/os/IBinder;
    ...
    invoke-virtual/range {v5 .. v11}, Landroid/app/Instrumentation;->execStartActivity(Landroid/content/Context;Landroid/os/IBinder;Landroid/os/IBinder;Landroid/app/Activity;Landroid/content/Intent;I)Landroid/app/Instrumentation$ActivityResult;

    move-result-object v16

    .line 3285
    .local v16, ar:Landroid/app/Instrumentation$ActivityResult;
    if-eqz v16, :cond_2
    ...
    invoke-virtual/range {v16 .. v16}, Landroid/app/Instrumentation$ActivityResult;->getResultCode()I

    move-result v9

    invoke-virtual/range {v16 .. v16}, Landroid/app/Instrumentation$ActivityResult;->getResultData()Landroid/content/Intent;
    ...
    iput-boolean v5, v0, Landroid/app/Activity;->mStartedActivity:Z

    .line 3303
    .end local v16           #ar:Landroid/app/Instrumentation$ActivityResult;
    :cond_3
    :goto_1
    return-void

    .line 3273
    .restart local v3       #intentPackageName:Ljava/lang/String;
    .restart local v15       #applicationPackageName:Ljava/lang/String;
    .restart local v17       #isIntentViewracle:Z
    :cond_4
    invoke-static {}, Landroid/app/ViewracleOption;->resetViewracleOption()V
    ...
    invoke-virtual {v5, v0, v1, v2}, Landroid/app/Activity;->startActivityFromChild(Landroid/app/Activity;Landroid/content/Intent;I)V
