...
.field public static final SCLOUD_ACCOUNTS_STATE:Ljava/lang/String; = "scloud_accounts_state"

.field public static final SCLOUD_DELETE_POLICY:Ljava/lang/String; = "scloud_delete_policy"

.field public static final SCLOUD_DOCS:Ljava/lang/String; = "scloud_docs"

.field public static final SCLOUD_ENABLED:Ljava/lang/String; = "scloud_enabled"

.field public static final SCLOUD_PHOTOS:Ljava/lang/String; = "scloud_photos"

.field public static final SCLOUD_PRIVATEFOLDER:Ljava/lang/String; = "scloud_privatefolder"

.field public static final SCLOUD_SOUNDS:Ljava/lang/String; = "scloud_sounds"

.field public static final SCLOUD_STORAGE_ID:Ljava/lang/String; = "scloud_storageid"

.field public static final SCLOUD_TOKEN:Ljava/lang/String; = "scloud_token"

.field public static final SCLOUD_TOKEN_SECRET:Ljava/lang/String; = "scloud_token_secret"

.field public static final SCLOUD_TRANSPORT:Ljava/lang/String; = "scloud_transport"

.field public static final SCLOUD_USERID:Ljava/lang/String; = "scloud_userid"

.field public static final SCLOUD_USE_MOBILE_NETWORK:Ljava/lang/String; = "scloud_mobile_net"

.field public static final SCLOUD_VIDEOS:Ljava/lang/String; = "scloud_videos"

.field public static final SCLOUD_VIDEO_PLAYBACK:Ljava/lang/String; = "scloud_video_playback"
...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v2, "scloud_enabled"

    aput-object v2, v0, v1

    const/16 v1, 0x9

    const-string/jumbo v2, "scloud_accounts_state"

    aput-object v2, v0, v1

    const/16 v1, 0xa

    const-string/jumbo v2, "scloud_transport"

    aput-object v2, v0, v1

    const/16 v1, 0xb

    const-string/jumbo v2, "scloud_privatefolder"

    aput-object v2, v0, v1

    const/16 v1, 0xc

    const-string/jumbo v2, "scloud_delete_policy"

    aput-object v2, v0, v1

    const/16 v1, 0xd

    const-string/jumbo v2, "scloud_video_playback"

    aput-object v2, v0, v1

    const/16 v1, 0xe

    const-string/jumbo v2, "scloud_photos"

    aput-object v2, v0, v1

    const/16 v1, 0xf

    const-string/jumbo v2, "scloud_videos"

    aput-object v2, v0, v1

    const/16 v1, 0x10

    const-string/jumbo v2, "scloud_sounds"

    aput-object v2, v0, v1

    const/16 v1, 0x11

    const-string/jumbo v2, "scloud_docs"

    aput-object v2, v0, v1

    const/16 v1, 0x12

    const-string/jumbo v2, "scloud_token"

    aput-object v2, v0, v1

    const/16 v1, 0x13

    const-string/jumbo v2, "scloud_userid"

    aput-object v2, v0, v1

    const/16 v1, 0x14

    const-string/jumbo v2, "scloud_storageid"

    aput-object v2, v0, v1

    const/16 v1, 0x15

    const-string/jumbo v2, "scloud_mobile_net"
    ...
    const-string/jumbo v2, "wifi_cmcc_relselection"
