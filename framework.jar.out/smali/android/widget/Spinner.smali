...
.method static synthetic access$200(Landroid/widget/Spinner;)Landroid/content/Context;
    .locals 1
    .parameter "x0"
...
.method layout(IZ)V
    ...
    .line 329
    .local v0, bViewGroup:Z
    iget-object v9, p0, Landroid/widget/AbsSpinner;->mSpinnerPadding:Landroid/graphics/Rect;

    iget v2, v9, Landroid/graphics/Rect;->left:I

    .line 330
    .local v2, childrenLeft:I
    ...
    .line 342
    :cond_2
    iget v9, p0, Landroid/widget/AdapterView;->mNextSelectedPosition:I
    ...
    invoke-virtual {p0, v9}, Landroid/widget/Spinner;->setSelectedPositionInt(I)V
    ...
    invoke-direct {p0}, Landroid/widget/Spinner;->isRtlLanguage()Z
    ...
    invoke-virtual {v9}, Landroid/widget/AbsSpinner$RecycleBin;->clear()V

    .line 372
    :cond_5
    iget v9, p0, Landroid/widget/AdapterView;->mSelectedPosition:I

    invoke-direct {p0, v9}, Landroid/widget/Spinner;->makeAndAddView(I)Landroid/view/View;
    ...
    .line 378
    .local v6, selectedOffset:I
    iget v9, p0, Landroid/widget/Spinner;->mGravity:I
    ...
    .line 395
    iput-boolean v11, p0, Landroid/widget/AdapterView;->mDataChanged:Z

    .line 396
    iput-boolean v11, p0, Landroid/widget/AdapterView;->mNeedSync:Z

    .line 397
    iget v9, p0, Landroid/widget/AdapterView;->mSelectedPosition:I

    invoke-virtual {p0, v9}, Landroid/widget/Spinner;->setNextSelectedPositionInt(I)V

    goto :goto_0

    .line 351
    .end local v5           #sel:Landroid/view/View;
    .end local v6           #selectedOffset:I
    ...
    .end local v4           #i:I
    .end local v7           #v:Landroid/view/View;
    .restart local v5       #sel:Landroid/view/View;
    .restart local v6       #selectedOffset:I
