...
.method public constructor <init>(Landroid/content/Context;Landroid/view/GestureDetector$OnGestureListener;Landroid/os/Handler;Z)V
    ...
    iget v2, p0, Landroid/view/GestureDetector;->mBiggerTouchSlop:I
...
.method public onTouchEvent_ex(Landroid/view/MotionEvent;)Z
    ...
    iput v2, v1, Landroid/view/GestureDetector$SurfaceTouchSharingData;->mSettingTapAndTwist:I
    ...
    iget v1, v1, Landroid/view/GestureDetector$SurfaceTouchSharingData;->mSettingTapAndTwist:I

    if-ne v1, v3, :cond_2

    iget-object v1, p0, Landroid/view/GestureDetector;->mTwistRecognizer:Landroid/view/GestureDetector$TwistRecognizer;

    invoke-virtual {v1}, Landroid/view/GestureDetector$TwistRecognizer;->Initialize()V
    ...
    invoke-virtual {v1, p1, v2}, Landroid/view/GestureDetector$TwistRecognizer;->Process(Landroid/view/MotionEvent;Landroid/view/GestureDetector$SurfaceTouchSharingData;)V
