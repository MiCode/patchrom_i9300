...
.method private dropStaleGestures(Landroid/view/MotionEvent;J)Z
    ...
    invoke-static {v8}, Landroid/webkit/WebView;->access$4200(Landroid/webkit/WebView;)Z
    ...
    invoke-static {v9}, Landroid/webkit/WebView;->access$4500(Landroid/webkit/WebView;)I
...
.method private handleQueuedMotionEvent(Landroid/view/MotionEvent;)V
    ...
    invoke-static {v2, p1, v0, v3, v4}, Landroid/webkit/WebView;->access$4600(Landroid/webkit/WebView;Landroid/view/MotionEvent;III)Z
...
.method private handleQueuedTouchEventData(Landroid/webkit/WebViewCore$TouchEventData;)V
    ...
    #getter for: Landroid/webkit/WebView;->mPreventDefault:I
    invoke-static {v5}, Landroid/webkit/WebView;->access$4000(Landroid/webkit/WebView;)I
    ...
    #getter for: Landroid/webkit/WebView;->mHandleTouchEventBeforePreventDefault:Z
    invoke-static {v0}, Landroid/webkit/WebView;->access$3900(Landroid/webkit/WebView;)Z
    ...
    .line 12439
    invoke-static {v3}, Landroid/webkit/WebView;->access$4802(Z)Z
    ...
    invoke-static {v0, v3}, Landroid/webkit/WebView;->access$4900(Landroid/webkit/WebView;Z)V
    ...
    invoke-static {v0}, Landroid/webkit/WebView;->access$3600(Landroid/webkit/WebView;)Landroid/graphics/Region;
    ...
    invoke-static {v0, v3}, Landroid/webkit/WebView;->access$4702(Landroid/webkit/WebView;Z)Z
    ...
    invoke-static {v0, v1}, Landroid/webkit/WebView;->access$5102(Landroid/webkit/WebView;F)F

    .line 12497
    iget-object v0, p0, Landroid/webkit/WebView$TouchEventQueue;->this$0:Landroid/webkit/WebView;

    #setter for: Landroid/webkit/WebView;->mDeferTouchMode:I
    invoke-static {v0, v6}, Landroid/webkit/WebView;->access$5202(Landroid/webkit/WebView;I)I
    ...
    invoke-static {v0}, Landroid/webkit/WebView;->access$5200(Landroid/webkit/WebView;)I
    ...
    #setter for: Landroid/webkit/WebView;->mDeferTouchMode:I
    invoke-static {v0, v1}, Landroid/webkit/WebView;->access$5202(Landroid/webkit/WebView;I)I
    ...
    invoke-static {v0, v1, v2}, Landroid/webkit/WebView;->access$5300(Landroid/webkit/WebView;FF)V

    .line 12509
    iget-object v0, p0, Landroid/webkit/WebView$TouchEventQueue;->this$0:Landroid/webkit/WebView;

    #calls: Landroid/webkit/WebView;->startDrag()V
    invoke-static {v0}, Landroid/webkit/WebView;->access$5400(Landroid/webkit/WebView;)V
    ...
    invoke-static {v2}, Landroid/webkit/WebView;->access$5100(Landroid/webkit/WebView;)F
    ...
    #getter for: Landroid/view/View;->mScrollY:I
    invoke-static {v1}, Landroid/webkit/WebView;->access$5800(Landroid/webkit/WebView;)I
    ...
    invoke-static {v0, v7, v8}, Landroid/webkit/WebView;->access$5900(Landroid/webkit/WebView;II)V
    ...
    #getter for: Landroid/view/View;->mScrollX:I
    invoke-static {v1}, Landroid/webkit/WebView;->access$6000(Landroid/webkit/WebView;)I
    ...
    #setter for: Landroid/webkit/WebView;->mDeferTouchMode:I
    invoke-static {v0, v13}, Landroid/webkit/WebView;->access$5202(Landroid/webkit/WebView;I)I
    ...
    #getter for: Landroid/webkit/WebView;->mLastTouchX:I
    invoke-static {v1}, Landroid/webkit/WebView;->access$4300(Landroid/webkit/WebView;)I
    ...
    #getter for: Landroid/webkit/WebView;->mLastTouchY:I
    invoke-static {v2}, Landroid/webkit/WebView;->access$4400(Landroid/webkit/WebView;)I
...
.method private handleTouchEventsBeforePreventDefault(Z)V
    ...
    invoke-static {v0, v1}, Landroid/webkit/WebView;->access$4102(Landroid/webkit/WebView;Z)Z
...
.method public enqueueTouchEvent(Landroid/view/MotionEvent;)V
    ...
    #getter for: Landroid/webkit/WebView;->mHandleTouchEventBeforePreventDefault:Z
    invoke-static {v3}, Landroid/webkit/WebView;->access$3900(Landroid/webkit/WebView;)Z
...
.method public enqueueTouchEvent(Landroid/webkit/WebViewCore$TouchEventData;)Z
    ...
    #getter for: Landroid/webkit/WebView;->mHandleTouchEventBeforePreventDefault:Z
    invoke-static {v5}, Landroid/webkit/WebView;->access$3900(Landroid/webkit/WebView;)Z
