...
.method constructor <init>(Landroid/webkit/WebView;Ljava/io/File;Landroid/graphics/Picture;Ljava/io/File;)V
    ...
    iput-object p2, p0, Landroid/webkit/WebView$8;->val$temp:Ljava/io/File;

    iput-object p3, p0, Landroid/webkit/WebView$8;->val$p:Landroid/graphics/Picture;

    iput-object p4, p0, Landroid/webkit/WebView$8;->val$dest:Ljava/io/File;
...
.method public run()V
    ...
    iget-object v2, p0, Landroid/webkit/WebView$8;->val$temp:Ljava/io/File;
    ...
    :try_start_1
    iget-object v2, p0, Landroid/webkit/WebView$8;->val$p:Landroid/graphics/Picture;
    ...
    iget-object v3, p0, Landroid/webkit/WebView$8;->val$dest:Ljava/io/File;
    ...
    :cond_2
    :goto_5
    iget-object v3, p0, Landroid/webkit/WebView$8;->val$temp:Ljava/io/File;
