...
.method private isAutoRetrieveMMSCondition(Ljava/lang/String;)Z
    ...
    const-string v6, "CscFeature_RIL_ForceConnectMMS"
    ...
    .line 2961
    const-string v5, "CSCFEATURE(RIL_FORCE_CONNECT_MMS) is enabled"
    ...
    .line 2966
    const-string v5, "FORCE_CONNECT_MMS::it\'s AutoReTrieveMMS Condition"
    ...
    .line 2983
    const-string v4, "FORCE_CONNECT_MMS::"
    ...
    const-string v6, "autoretrieveMMS condition: not allowed due to"
...
.method private trySetupData(Lcom/android/internal/telephony/ApnContext;)Z
    ...
    invoke-direct {p0, v6}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->isAutoRetrieveMMSCondition(Ljava/lang/String;)Z
...
.method public fakeDisableApnType(Ljava/lang/String;)I
    .locals 6
    .parameter "type"
    ...
    const-string v4, "fakeDisableApnType:"
    ...
    .line 610
    const-string v3, "fakeDisableApnType:: NO ApnContext"
    ...
    const-string v4, "fakeDisableApnType:: apnContext="
    ...
    const-string v4, "fakeDisableApnType::applyNewState("
    ...
    invoke-virtual {v3, v4, v1}, Lcom/android/internal/telephony/DataConnection;->fakeTearDown(Ljava/lang/String;Landroid/os/Message;)V
    ...
    .line 629
    invoke-virtual {v0, v5}, Lcom/android/internal/telephony/ApnContext;->setDataConnectionAc(Lcom/android/internal/telephony/DataConnectionAc;)V
...
.method protected onMobileDataDbChanged()V
    ...
    const-string/jumbo v3, "onDataConnectionDbChanged > NETWORK_MODE_GSM_UMTS"
...
.method protected onScreenStateChanged(Z)V
    ...
    .line 2486
    const-string/jumbo v4, "onScreenStateChanged: reset retry count in default dc."
    ...
    .line 2491
    .local v3, state:Lcom/android/internal/telephony/DataConnectionTracker$State;
    sget-object v4, Lcom/android/internal/telephony/DataConnectionTracker$State;->CONNECTED:Lcom/android/internal/telephony/DataConnectionTracker$State;
    ...
    .line 2492
    const-string/jumbo v4, "onScreenStateChanged: retry connect"
    ...
    invoke-direct {p0, v4}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->cancelReconnectAlarm(Lcom/android/internal/telephony/DataConnectionAc;)V
    ...
    invoke-virtual {p0, v4, v0}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;

    move-result-object v4

    invoke-virtual {p0, v4}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->sendMessage(Landroid/os/Message;)Z
    ...
    .end local v3           #state:Lcom/android/internal/telephony/DataConnectionTracker$State;
    :cond_2
    return-void
.end method
