...
.method private getMWTaskActivity(Landroid/content/ComponentName;)Landroid/content/ComponentName;
    .locals 5
    .parameter "cn"
...
.method private isFullScreenCheck(Lcom/android/server/am/ActivityRecord;)Z
    .locals 4
    .parameter "r"
    ...
    .line 1282
    .local v1, mwm:Lcom/android/server/sec/MultiWindowManagerService;
    iget-object v2, p1, Lcom/android/server/am/ActivityRecord;->realActivity:Landroid/content/ComponentName;

    invoke-virtual {v1, v2}, Lcom/android/server/sec/MultiWindowManagerService;->isMultiWindow(Landroid/content/ComponentName;)Z
    ...
    invoke-virtual {v1, v2}, Lcom/android/server/sec/MultiWindowManagerService;->isMaximized(Landroid/content/ComponentName;)Z
    ...
    invoke-virtual {v2, v3}, Lcom/android/server/wm/WindowManagerService;->isMaximized(Landroid/content/ComponentName;)Z
...
.method private isVisibleCnt(Ljava/util/ArrayList;)Z
    .locals 10
    .parameter
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    .prologue
    .local p1, lst:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/lang/String;>;"
    const/4 v9, 0x2
    ...
    .line 1265
    .local v2, mManager:Landroid/sec/multiwindow/IMultiWindowManager;
    new-instance v4, Ljava/util/ArrayList;

    invoke-direct {v4}, Ljava/util/ArrayList;-><init>()V

    .line 1266
    .local v4, rList:Ljava/util/List;,"Ljava/util/List<Landroid/graphics/Rect;>;"
    const/4 v1, 0x0
    ...
    invoke-virtual {v3, v0}, Lcom/android/server/sec/MultiWindowManagerService;->isMultiWindow(Landroid/content/ComponentName;)Z

    move-result v6

    if-eqz v6, :cond_2

    invoke-virtual {v3, v0}, Lcom/android/server/sec/MultiWindowManagerService;->isMaximized(Landroid/content/ComponentName;)Z
    ...
    invoke-virtual {v6, v0}, Lcom/android/server/wm/WindowManagerService;->isMaximized(Landroid/content/ComponentName;)Z
    ...
    invoke-interface {v6}, Landroid/sec/multiwindow/IMultiWindow;->getRect()Landroid/graphics/Rect;

    move-result-object v5

    .line 1272
    .local v5, re:Landroid/graphics/Rect;
    ...
    .line 1266
    .end local v5           #re:Landroid/graphics/Rect;
    :cond_2
    add-int/lit8 v1, v1, 0x1
...
.method final ensureActivitiesVisibleLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;Ljava/lang/String;I)V
    ...
    .line 1318
    .local v11, fullcheck:Z
    const/4 v13, 0x0

    .line 1319
    .local v13, iMultiWindowType:I
    new-instance v14, Ljava/util/ArrayList;

    invoke-direct {v14}, Ljava/util/ArrayList;-><init>()V

    .line 1320
    .local v14, lst:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/lang/String;>;"
    const/16 v16, 0x0

    .line 1321
    .local v16, mwm:Lcom/android/server/sec/MultiWindowManagerService;
    const/4 v5, 0x0

    .line 1323
    .local v5, bMwModeCheck:Z
    move-object/from16 v0, p0
    ...
    invoke-static/range {v20 .. v20}, Landroid/sec/multiwindow/MultiWindowManager;->isMultiWindowServiceEnabled(Landroid/content/Context;)Z
    ...
    .line 1333
    invoke-virtual/range {v16 .. v16}, Lcom/android/server/sec/MultiWindowManagerService;->getScreenOn()Z
    ...
    .line 1335
    invoke-virtual/range {v16 .. v16}, Lcom/android/server/sec/MultiWindowManagerService;->getMultiWindowType()I
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    sget-object v20, Landroid/sec/multiwindow/MultiWindowType;->eFreestyleWindow:Landroid/sec/multiwindow/MultiWindowType;

    invoke-virtual/range {v20 .. v20}, Landroid/sec/multiwindow/MultiWindowType;->getiValue()I
    ...
    invoke-virtual {v0, v7}, Lcom/android/server/sec/MultiWindowManagerService;->isVisible(Landroid/content/ComponentName;)Z
    ...
    const-string v22, "iMultiWindowType error : "
    ...
    invoke-static/range {v20 .. v21}, Landroid/sec/multiwindow/MWlog;->e(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-virtual {v0, v7}, Lcom/android/server/sec/MultiWindowManagerService;->isMultiWindow(Landroid/content/ComponentName;)Z
    ...
    .line 1358
    :cond_7
    sget-object v20, Landroid/sec/multiwindow/MultiWindowType;->eSplitWindow:Landroid/sec/multiwindow/MultiWindowType;
    ...
    invoke-direct {v0, v1}, Lcom/android/server/am/ActivityStack;->isFullScreenCheck(Lcom/android/server/am/ActivityRecord;)Z
    :try_end_2
    ...
    invoke-virtual/range {v20 .. v22}, Lcom/android/server/wm/WindowManagerService;->setAppVisibility(Landroid/os/IBinder;Z)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/sec/MultiWindowManagerService;->isVisible(Landroid/content/ComponentName;)Z
    ...
    invoke-static/range {v20 .. v20}, Landroid/sec/multiwindow/MultiWindowUtil;->isLauncher(Ljava/lang/String;)Z
    ...
    .line 1410
    .restart local v9       #doThisProcess:Z
    :cond_1b
    move-object/from16 v0, v18
    ...
    invoke-interface/range {v20 .. v22}, Landroid/app/IApplicationThread;->scheduleWindowVisibility(Landroid/os/IBinder;Z)V
    ...
    const-string v22, "Exception thrown making visibile: "
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/sec/MultiWindowManagerService;->isMultiWindow(Landroid/content/ComponentName;)Z
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/sec/MultiWindowManagerService;->isMaximized(Landroid/content/ComponentName;)Z
    ...
    invoke-direct {v0, v14}, Lcom/android/server/am/ActivityStack;->isVisibleCnt(Ljava/util/ArrayList;)Z
    ...
    sget-object v21, Lcom/android/server/am/ActivityStack$ActivityState;->STOPPING:Lcom/android/server/am/ActivityStack$ActivityState;
    ...
    sget-object v21, Lcom/android/server/am/ActivityStack$ActivityState;->STOPPED:Lcom/android/server/am/ActivityStack$ActivityState;
    ...
    const-string v22, "Exception thrown making hidden: "
...
.method public moveMwTasksToFrontLocked()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/am/ActivityStack;->moveMwTasksToFrontLocked(Landroid/content/ComponentName;)V

    .line 4365
    return-void
.end method

.method public moveMwTasksToFrontLocked(Landroid/content/ComponentName;)V
    .locals 14
    .parameter "cn"
    ...
    .line 4370
    .local v4, imws:Lcom/android/server/sec/MultiWindowManagerService;
    new-instance v6, Ljava/util/ArrayList;

    invoke-direct {v6}, Ljava/util/ArrayList;-><init>()V

    .line 4371
    .local v6, mwtasks:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/server/am/TaskRecord;>;"
    const/4 v7, 0x0

    .line 4372
    .local v7, top:Lcom/android/server/am/TaskRecord;
    invoke-virtual {v4, p1}, Lcom/android/server/sec/MultiWindowManagerService;->isMaximized(Landroid/content/ComponentName;)Z
    ...
    .local v1, hr:Lcom/android/server/am/ActivityRecord;
    :try_start_0
    iget-object v10, v1, Lcom/android/server/am/ActivityRecord;->realActivity:Landroid/content/ComponentName;

    invoke-virtual {v4, v10}, Lcom/android/server/sec/MultiWindowManagerService;->isRunning(Landroid/content/ComponentName;)Z
    ...
    invoke-virtual {v4, v10}, Lcom/android/server/sec/MultiWindowManagerService;->isMaximized(Landroid/content/ComponentName;)Z
    ...
    invoke-static {v10}, Landroid/sec/multiwindow/MultiWindowManager;->getInstance(Landroid/content/Context;)Landroid/sec/multiwindow/IMultiWindowManager;

    move-result-object v5

    .line 4402
    .local v5, mwm:Landroid/sec/multiwindow/IMultiWindowManager;
    iget-object v10, v7, Lcom/android/server/am/TaskRecord;->realActivity:Landroid/content/ComponentName;

    invoke-interface {v5, v10}, Landroid/sec/multiwindow/IMultiWindowManager;->getWindowInstance(Landroid/content/ComponentName;)Landroid/sec/multiwindow/IMultiWindow;

    move-result-object v9

    .line 4403
    .local v9, window:Landroid/sec/multiwindow/IMultiWindow;
    if-eqz v9, :cond_5

    .line 4404
    invoke-interface {v9}, Landroid/sec/multiwindow/IMultiWindow;->isMaximized()Z
    ...
    .line 4405
    invoke-virtual {p0, v7, v13}, Lcom/android/server/am/ActivityStack;->moveTaskToFrontLocked(Lcom/android/server/am/TaskRecord;Lcom/android/server/am/ActivityRecord;)V
    ...
    const-string v12, "moveMwTaskToFrontLocked @ ActivityStack - "

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v11

    iget-object v12, v7, Lcom/android/server/am/TaskRecord;->realActivity:Landroid/content/ComponentName;

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    move-result-object v11

    const-string v12, " is moved to front"
    ...
    invoke-static {v10, v11}, Landroid/sec/multiwindow/MWlog;->i(Ljava/lang/String;Ljava/lang/String;)I

    goto/16 :goto_0

    .line 4412
    .end local v5           #mwm:Landroid/sec/multiwindow/IMultiWindowManager;
    .end local v9           #window:Landroid/sec/multiwindow/IMultiWindow;
    :cond_5
    ...
    invoke-virtual {p0, v8, v13}, Lcom/android/server/am/ActivityStack;->moveTaskToFrontLocked(Lcom/android/server/am/TaskRecord;Lcom/android/server/am/ActivityRecord;)V
...
.method final resumeTopActivityLocked(Lcom/android/server/am/ActivityRecord;)Z
    ...
    invoke-direct {v0, v2}, Lcom/android/server/am/ActivityStack;->isShowAppStartingPreview(Landroid/content/ComponentName;)Z

    move-result v16

    .line 1908
    .local v16, doPreview:Z
    if-eqz v16, :cond_1a
...
.method final startActivityLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;[Landroid/net/Uri;ILandroid/content/pm/ActivityInfo;Landroid/os/IBinder;Ljava/lang/String;IIIZZ[Lcom/android/server/am/ActivityRecord;)I
    ...
    .line 2657
    .local v41, rp:Landroid/app/enterprise/IRestrictionPolicy;
    if-eqz v41, :cond_3
    ...
    .end local v33           #len$:I
    .end local v41           #rp:Landroid/app/enterprise/IRestrictionPolicy;
    :cond_3
    :goto_2
    ...
    .line 2752
    .local v42, sourceRecord:Lcom/android/server/am/ActivityRecord;
    const/4 v5, 0x0
    ...
    .line 2759
    .restart local v42       #sourceRecord:Lcom/android/server/am/ActivityRecord;
    if-ltz p9, :cond_5
    ...
    .end local v36           #oldPolicy:Landroid/os/StrictMode$ThreadPolicy;
    :cond_6
    const-string v3, "ActivityManager"
    ...
    .restart local v36       #oldPolicy:Landroid/os/StrictMode$ThreadPolicy;
    .restart local v41       #rp:Landroid/app/enterprise/IRestrictionPolicy;
    :cond_7
    ...
    .line 2686
    .local v31, km:Landroid/app/enterprise/kioskmode/IKioskMode;
    if-eqz v31, :cond_3
    ...
    .line 2690
    .end local v31           #km:Landroid/app/enterprise/kioskmode/IKioskMode;
    :catch_1
    move-exception v24
    ...
    .line 2697
    .local v40, pwdPolicy:Landroid/app/enterprise/IPasswordPolicy;
    if-eqz v40, :cond_3

    invoke-interface/range {v40 .. v40}, Landroid/app/enterprise/IPasswordPolicy;->isChangeRequested()I
    ...
    .line 2701
    .local v43, topActivity:Ljava/lang/String;
    const/16 v29, 0x0
    ...
    .end local v40           #pwdPolicy:Landroid/app/enterprise/IPasswordPolicy;
    .end local v43           #topActivity:Ljava/lang/String;
    :catch_2
    move-exception v24
    ...
    .line 2838
    .local v44, watchIntent:Landroid/content/Intent;
    move-object/from16 v0, p0
    ...
    .line 2844
    .end local v44           #watchIntent:Landroid/content/Intent;
    :goto_a
    if-eqz v19, :cond_1c
    ...
    .line 2838
    .restart local v44       #watchIntent:Landroid/content/Intent;
    :cond_1b
    const/16 v19, 0x0
    ...
    .line 2869
    new-instance v38, Lcom/android/server/am/ActivityManagerService$PendingActivityLaunch;

    invoke-direct/range {v38 .. v38}, Lcom/android/server/am/ActivityManagerService$PendingActivityLaunch;-><init>()V

    .line 2870
    .local v38, pal:Lcom/android/server/am/ActivityManagerService$PendingActivityLaunch;
    ...
    .line 2881
    .end local v38           #pal:Lcom/android/server/am/ActivityManagerService$PendingActivityLaunch;
    :cond_1f
    move-object/from16 v0, p0
...
.method final startActivityMayWait(Landroid/app/IApplicationThread;ILandroid/content/Intent;Ljava/lang/String;[Landroid/net/Uri;ILandroid/os/IBinder;Ljava/lang/String;IZZLjava/lang/String;Landroid/os/ParcelFileDescriptor;ZLandroid/app/IActivityManager$WaitResult;Landroid/content/res/Configuration;)I
    ...
    .line 3384
    .local v28, imws:Lcom/android/server/sec/MultiWindowManagerService;
    new-instance v2, Landroid/content/ComponentName;
    ...
    invoke-direct {v0, v2}, Lcom/android/server/am/ActivityStack;->getMWTaskActivity(Landroid/content/ComponentName;)Landroid/content/ComponentName;

    move-result-object v25

    .line 3385
    .local v25, componentName:Landroid/content/ComponentName;
    invoke-virtual/range {v28 .. v28}, Lcom/android/server/sec/MultiWindowManagerService;->getMultiWindowType()I
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/am/ActivityStack;->isInStackLocked(Landroid/os/IBinder;)Lcom/android/server/am/ActivityRecord;
    ...
    const-string v4, "startActivityMayWait @ ActivityStack - intent.getAction() == null && ar != null"
    ...
    invoke-virtual {v2, v0}, Lcom/android/server/am/ActivityManagerService;->moveMwTasksToFront(Landroid/content/ComponentName;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .end local v28           #imws:Lcom/android/server/sec/MultiWindowManagerService;
    :cond_1
    :goto_1
    move-object/from16 v0, p0
    ...
    .restart local v28       #imws:Lcom/android/server/sec/MultiWindowManagerService;
    :cond_a
    :try_start_7
    ...
    invoke-virtual {v0, v2}, Lcom/android/server/sec/MultiWindowManagerService;->isRunning(Landroid/content/ComponentName;)Z
    ...
    .line 3395
    invoke-virtual/range {v28 .. v28}, Lcom/android/server/sec/MultiWindowManagerService;->maximizeAll()Z
    :try_end_7
