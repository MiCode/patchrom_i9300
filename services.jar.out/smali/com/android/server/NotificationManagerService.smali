...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/NotificationManagerService$OverTurnSettingsObserver;,
...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/StatusBarManagerService;Lcom/android/server/LightsService;)V
    ...
    invoke-direct {v5, p0, v9}, Lcom/android/server/NotificationManagerService$PickupPlayer;-><init>(Lcom/android/server/NotificationManagerService;Lcom/android/server/NotificationManagerService$1;)V
    ...
    invoke-direct {v5, p0, v9}, Lcom/android/server/NotificationManagerService$WorkerHandler;-><init>(Lcom/android/server/NotificationManagerService;Lcom/android/server/NotificationManagerService$1;)V
...
.method static synthetic access$2200(Lcom/android/server/NotificationManagerService;)Landroid/os/PowerManager$WakeLock;
    .locals 1
    .parameter "x0"
...
.method private cancelNotification(Ljava/lang/String;Ljava/lang/String;IIIZ)V
    ...
    const-string v5, "cancelNotification - pkg:"
...
.method private doVibrate(ZZLandroid/app/Notification;)V
    ...
    :goto_1
    sget-object v3, Landroid/os/Vibrator$MagnitudeType;->NotificationMagnitude:Landroid/os/Vibrator$MagnitudeType;

    invoke-virtual {v1, v2, v0, v3}, Landroid/os/Vibrator;->vibrate([JILandroid/os/Vibrator$MagnitudeType;)V
...
.method public enqueueNotificationInternal(Ljava/lang/String;IILjava/lang/String;IILandroid/app/Notification;[I)V
    ...
    const-string v8, "enqueueNotificationInternal - pkg:"
    ...
    invoke-static {v6, v8}, Landroid/util/safelog/Slog;->e(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-static {v6, v7}, Landroid/util/safelog/Log;->isLoggable(Ljava/lang/String;I)Z
    ...
    const-string v8, "Noti Alert - mSystemReady:"
    ...
    iget-boolean v8, v0, Lcom/android/server/NotificationManagerService;->mSystemReady:Z

    invoke-virtual {v6, v8}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    move-result-object v6

    const-string v8, ", AlertEnabled:"
    ...
    invoke-static {v7, v6}, Landroid/util/safelog/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I
    ...
    const-string v8, "Noti Alert - mSound.play :"
    ...
    const-string v7, "Noti Alert - doVibrate "
...
.method public enqueueToast(Ljava/lang/String;Landroid/app/ITransientNotification;I)V
    ...
    .prologue
    .line 561
    const-string v12, "STATUSBAR-NotificationService"

    const-string v13, "enqueueToast()"

    invoke-static {v12, v13}, Landroid/util/safelog/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-static {v12, v13}, Landroid/util/safelog/Slog;->e(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-static {v12, v14}, Landroid/util/safelog/Slog;->e(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_1
...
.method systemReady()V
    ...
    iput-boolean v3, p0, Lcom/android/server/NotificationManagerService;->mSystemReady:Z

    .line 539
    new-instance v2, Lcom/android/server/NotificationManagerService$PickupSettingsObserver;

    iget-object v3, p0, Lcom/android/server/NotificationManagerService;->mHandler:Lcom/android/server/NotificationManagerService$WorkerHandler;

    invoke-direct {v2, p0, v3}, Lcom/android/server/NotificationManagerService$PickupSettingsObserver;-><init>(Lcom/android/server/NotificationManagerService;Landroid/os/Handler;)V

    .line 540
    .local v2, pickupObserver:Lcom/android/server/NotificationManagerService$PickupSettingsObserver;
    invoke-virtual {v2}, Lcom/android/server/NotificationManagerService$PickupSettingsObserver;->observe()V

    .line 541
    const-string v3, "STATUSBAR-NotificationService"

    const-string v4, "pickupObserver.observe()"

    invoke-static {v3, v4}, Landroid/util/safelog/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 546
    new-instance v0, Lcom/android/server/NotificationManagerService$MotionSettingsObserver;

    iget-object v3, p0, Lcom/android/server/NotificationManagerService;->mHandler:Lcom/android/server/NotificationManagerService$WorkerHandler;

    invoke-direct {v0, p0, v3}, Lcom/android/server/NotificationManagerService$MotionSettingsObserver;-><init>(Lcom/android/server/NotificationManagerService;Landroid/os/Handler;)V

    .line 547
    .local v0, motionObserver:Lcom/android/server/NotificationManagerService$MotionSettingsObserver;
    invoke-virtual {v0}, Lcom/android/server/NotificationManagerService$MotionSettingsObserver;->observe()V

    .line 548
    const-string v3, "STATUSBAR-NotificationService"

    const-string v4, "motionObserver.observe()"

    invoke-static {v3, v4}, Landroid/util/safelog/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 551
    new-instance v1, Lcom/android/server/NotificationManagerService$OverTurnSettingsObserver;

    iget-object v3, p0, Lcom/android/server/NotificationManagerService;->mHandler:Lcom/android/server/NotificationManagerService$WorkerHandler;

    invoke-direct {v1, p0, v3}, Lcom/android/server/NotificationManagerService$OverTurnSettingsObserver;-><init>(Lcom/android/server/NotificationManagerService;Landroid/os/Handler;)V

    .line 552
    .local v1, overturnObserver:Lcom/android/server/NotificationManagerService$OverTurnSettingsObserver;
    invoke-virtual {v1}, Lcom/android/server/NotificationManagerService$OverTurnSettingsObserver;->observe()V

    .line 553
    const-string v3, "STATUSBAR-NotificationService"

    const-string v4, "overturnObserver.observe();"
