...
.field private static final RESTORE_DEFAULT_NETWORK_DELAY_CMCC:I = 0x927c0
...
.method private networkTypeToApnType(I)Ljava/lang/String;
    .locals 2
    .parameter "netType"
...
.method private stopUsingNetworkFeature(Lcom/android/server/ConnectivityService$FeatureUser;Z)I
    ...
    .prologue
    .line 1173
    iget v5, p1, Lcom/android/server/ConnectivityService$FeatureUser;->mNetworkType:I
    ...
    iget v6, p1, Lcom/android/server/ConnectivityService$FeatureUser;->mPid:I
    ...
    const-string v12, "stopUsingNetworkFeature: net "
    ...
    .line 1189
    invoke-static {v5}, Landroid/net/ConnectivityManager;->isNetworkTypeValid(I)Z
    ...
    const-string v12, ", net is invalid"
    ...
    .line 1203
    const-string v11, "stopUsingNetworkFeature: this process has no outstanding requests, ignoring"
    ...
    .line 1220
    const-string v11, "stopUsingNetworkFeature: dup is found, ignoring"
    ...
    :cond_3
    invoke-virtual {p0, v5, v2}, Lcom/android/server/ConnectivityService;->convertFeatureToNetworkType(ILjava/lang/String;)I
    ...
    invoke-direct {p0, v6, v11}, Lcom/android/server/ConnectivityService;->reassessPidDns(IZ)V
    ...
    const-string v12, " others still using it"
    ...
    const-string v12, "stopUsingNetworkFeature: teardown net "
...
.method public ResetCwDefaultService(Ljava/lang/String;)V
    ...
    const-string v14, "CW_SISO : ResetCwDefaultService Entered"
    ...
    .line 2791
    .local v12, szWifiIntfName:Ljava/lang/String;
    ...
    .line 2798
    .local v1, CW_GWAddress:Ljava/net/InetAddress;
    const/4 v7, 0x0

    .line 2800
    .local v7, nIntCW_GWAddress:I
    const/4 v6, 0x0

    .line 2801
    .local v6, nCurrentGWAddress:Ljava/net/InetAddress;
    const/4 v8, 0x0

    .line 2804
    .local v8, nIntCurrentGWAddress:I
    const-string v13, "wifi.interface"
    ...
    iget-object v13, v0, Lcom/android/server/ConnectivityService;->mCWWifiRoutes:Ljava/util/Collection;
    ...
    iget-object v14, v0, Lcom/android/server/ConnectivityService;->mCWPPProute:Landroid/net/RouteInfo;

    move-object/from16 v0, p1

    invoke-interface {v13, v0, v14}, Landroid/os/INetworkManagementService;->removeRoute(Ljava/lang/String;Landroid/net/RouteInfo;)V
    :try_end_0
    ...
    const-string v14, "CW_SISO ResetCwDefaultService : Trying to add wlan as default route "
    ...
    invoke-interface {v13, v12, v11}, Landroid/os/INetworkManagementService;->addRoute(Ljava/lang/String;Landroid/net/RouteInfo;)V
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
    ...
    const-string v14, "CW_SISO ResetCwDefaultService : addRoute exception "
    ...
    iget-object v14, v0, Lcom/android/server/ConnectivityService;->mCWdnsServers:[Ljava/lang/String;
    ...
    iput-object v13, v0, Lcom/android/server/ConnectivityService;->mCWWifiRoutes:Ljava/util/Collection;
    ...
    iput-object v13, v0, Lcom/android/server/ConnectivityService;->mCWPPProute:Landroid/net/RouteInfo;

    .line 2835
    move-object/from16 v0, p0

    iget-object v13, v0, Lcom/android/server/ConnectivityService;->mCWdnsServers:[Ljava/lang/String;
    ...
    const-string v14, "CW_SISO ResetCwDefaultService : removeRoute exception "
    ...
    const-string v14, "CW_SISO : mCWWifiRoutes is null"
...
.method public SetCwDefaultService(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)V
    ...
    const-string v23, "CW_SISO : SetCwDefaultService Entered"
    ...
    .line 2666
    .local v9, dnsServers:[Ljava/lang/String;
    const/16 v18, 0x0

    .line 2667
    .local v18, remoteAddr:Ljava/net/InetAddress;
    const/4 v5, 0x0
    ...
    .line 2670
    .local v16, nTempVar:I
    const/4 v4, 0x0

    .line 2671
    .local v4, WifiGWAddress:I
    const-string v21, "eth0"

    .line 2672
    .local v21, szWifiIntfName:Ljava/lang/String;
    const/4 v7, 0x0
    ...
    const-string v22, "wifi.interface"
    ...
    const-string v24, "CW_SISO : SetCwDefaultService Interface Name: "
    ...
    .line 2681
    .local v11, gatewayAddress:Ljava/lang/String;
    const/16 v22, 0x0
    ...
    .line 2684
    .local v13, ipAddress:Ljava/lang/String;
    new-instance v22, Ljava/lang/StringBuilder;
    ...
    .line 2686
    .local v19, remoteipAddress:Ljava/lang/String;
    const-string v22, "ConnectivityService"
    ...
    const-string v24, "CW_SISO : SetCwDefaultService interface="
    ...
    const-string v24, "CW_SISO SetCwDefaultService : Trying to Set the Default interface : "
    ...
    invoke-virtual/range {v20 .. v20}, Landroid/net/RouteInfo;->getGateway()Ljava/net/InetAddress;

    move-result-object v22

    invoke-static/range {v22 .. v22}, Landroid/net/NetworkUtils;->inetAddressToInt(Ljava/net/InetAddress;)I
    ...
    const-string v24, "CW_SISO SetCwDefaultService : WifiGWAddress :"
    ...
    const-string v23, "CW_SISO SetCwDefaultService : removeRoute 2 exception "
    ...
    const-string v23, "CW_SISO SetCwDefaultService :  exception "
    ...
    const-string v23, "CW_SISO SetCwDefaultService : removeRoute 1 exception "
    ...
    invoke-direct {v14, v3, v0}, Landroid/net/LinkAddress;-><init>(Ljava/net/InetAddress;I)V
    ...
    invoke-direct {v8, v0, v1}, Landroid/net/LinkAddress;-><init>(Ljava/net/InetAddress;I)V
    :try_end_7
    .catch Ljava/lang/Exception; {:try_start_7 .. :try_end_7} :catch_1

    .line 2745
    .end local v7           #destination:Landroid/net/LinkAddress;
    .local v8, destination:Landroid/net/LinkAddress;
    :try_start_8
    ...
    invoke-direct {v0, v8, v1}, Landroid/net/RouteInfo;-><init>(Landroid/net/LinkAddress;Ljava/net/InetAddress;)V
    ...
    const-string v23, "CW_SISO SetCwDefaultService : Trying to setDefaultRoute Called "
    ...
    .line 2760
    .end local v8           #destination:Landroid/net/LinkAddress;
    ...
    const-string v23, "CW_SISO SetCwDefaultService : numericToInetAddress exception "
    ...
    const-string v23, "CW_SISO SetCwDefaultService : numericToInetAddress 2 exception "
    ...
    .end local v7           #destination:Landroid/net/LinkAddress;
    .end local v10           #e:Ljava/lang/Exception;
    .restart local v8       #destination:Landroid/net/LinkAddress;
    ...
    const-string v23, "CW_SISO SetCwDefaultService : addRoute exception "
    ...
    const-string v23, "CW_SISO : remote ip address is 0 : "
...
.method public getEntireMobileDataEnabled()Z
    .locals 6
    ...
    const-string v3, "getEntireMobileDataEnabled returning "
...
.method public startUsingNetworkFeature(ILjava/lang/String;Landroid/os/IBinder;)I
    ...
    const-string v19, "startUsingNetworkFeature for net "
    ...
    .line 1110
    const-string v18, "special network already active"
    ...
    .end local v14           #token:J
    :cond_c
    const-string v18, "special network already connecting"
